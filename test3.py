...
list_snellen=["E.jpg","E60.jpg","E36.jpg","E24.jpg","E12.jpg","E9.jpg","E6.jpg","E3.jpg"]
print(list_snellen)
...
def main():
	...
	while True:
		...
		if key_press=='s':#Snellen Chart
			...
			chart(bangla_path,list_snellen,"b")
			...
			with open("conf.txt","w") as f:
				f.write("/home/pi-3bplus/Images/8ft/")	
			break		
		elif key_press=="9":#9 feet
			cv2.destroyAllWindows()
			with open("conf.txt","w") as f:
				f.write("/home/pi-3bplus/Images/9ft/")	
			break		
